package com.ahmedadeltito.photoeditor.filter;
...
public class ThumbAdapter extends RecyclerView.Adapter<ThumbAdapter.MyViewHolder> {
    ...
    public ThumbAdapter(Context context, List<ThumbnailItem> thumbnailItemList, ThumbnailsAdapterListener listener) {
        mContext = context;
