...
public class ImageAdapter extends RecyclerView.Adapter<ImageAdapter.ViewHolder> {
    ...
    public ImageAdapter(@NonNull Context context, @NonNull List<StickerModel> imageBitmaps) {
        this.inflater = LayoutInflater.from(context);
        this.stickers = imageBitmaps;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        holder.imageView.setImageBitmap(stickers.get(position).mBitmap);
    }
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (onImageClickListener != null)
                        onImageClickListener.onImageClickListener(stickers.get(getAdapterPosition()).mBitmap);
                }
            });
        }
    }
